#pragma once
#ifndef __INIT_GAME_PLAY_STATE_H__
#define __INIT_GAME_PLAY_STATE_H__

#include "State.h"
#include "DejavuGame.h"

class InitGamePlayState : public State {

private:
	enum class InitGamePlayInnerStates {
		GamePlayInit,
	};

	InitGamePlayInnerStates _innerState;

public: 
	InitGamePlayState();
	virtual ~InitGamePlayState();
...
#endif //__INIT_GAME_PLAY_STATE_H__